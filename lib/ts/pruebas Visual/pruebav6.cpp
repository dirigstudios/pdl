...
int main(int argc, char **argv)
{
  ...
  tabla.CrearEntrada((TipoEntrada)8,"posicionmemoria",puntero);
  ...
  tabla.CrearEntrada(funcion,"parametros",(Tipo)11);
  tabla.CrearEntrada((TipoEntrada)87,"direccion",puntero);

  tabla.CrearEntrada((TipoEntrada)88,"numparam",entero);
  tabla.CrearEntrada(procedimiento,"parametros",(Tipo)50);
  tabla.CrearEntrada(procedimiento,"direccion",(Tipo)ptr);

  tabla.CrearEntrada((TipoEntrada)12,"posicionsalto",puntero);

  tabla.CrearEntrada((TipoEntrada)44,"posicion",puntero);
